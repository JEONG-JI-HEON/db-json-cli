...
export const errorMessages = {
  ...
  INVALID_ID_FORMAT: "올바른 ID 형식이 아닙니다",
  INVALID_QUERY_PARAMS: "올바르지 않은 쿼리 파라미터입니다",
  ...
  CONFLICT: "요청이 현재 서버 상태와 충돌합니다",
  GONE: "요청한 리소스가 더 이상 존재하지 않습니다",
};
  ...
  register: {
    ...
    responses: {
      ...
      422: {
        ...
        example: { message: errorMessages.INVALID_EMAIL_FORMAT },
      },
      500: {
        description: "서버 오류",
  ...
  login: {
    ...
    responses: {
      ...
      429: {
        ...
        example: { message: errorMessages.TOO_MANY_REQUESTS },
      },
      500: {
        description: "서버 오류",
  ...
  routeList.forEach((r) => {
    ...
    schemas.push({
      ...
      responses: {
        ...
        400: { description: "잘못된 쿼리 파라미터", example: { message: errorMessages.INVALID_QUERY_PARAMS } },
        401: { description: "인증 필요", example: { message: errorMessages.NO_TOKEN } },
        403: { description: "접근 금지", example: { message: errorMessages.FORBIDDEN } },
    ...
    schemas.push({
      ...
      responses: {
        ...
        400: { description: "잘못된 ID 형식", example: { message: errorMessages.INVALID_ID_FORMAT } },
        401: { description: "인증 필요", example: { message: errorMessages.NO_TOKEN } },
        403: { description: "접근 금지", example: { message: errorMessages.FORBIDDEN } },
    ...
    schemas.push({
      ...
      responses: {
        ...
        403: { description: "접근 금지", example: { message: errorMessages.FORBIDDEN } },
        404: { description: "리소스를 찾을 수 없음", example: { message: errorMessages.RESOURCE_NOT_FOUND } },
        409: { description: "중복된 항목", example: { message: errorMessages.DUPLICATE_ENTRY } },
        413: { description: "요청 데이터 크기 초과", example: { message: errorMessages.PAYLOAD_TOO_LARGE } },
        422: { description: "유효성 검증 실패", example: { message: errorMessages.MISSING_REQUIRED_FIELDS } },
    ...
    schemas.push({
      ...
      responses: {
        ...
        403: { description: "접근 금지", example: { message: errorMessages.FORBIDDEN } },
        404: { description: "항목을 찾을 수 없음", example: { message: errorMessages.ITEM_NOT_FOUND } },
        409: { description: "충돌", example: { message: errorMessages.CONFLICT } },
        422: { description: "유효성 검증 실패", example: { message: errorMessages.MISSING_REQUIRED_FIELDS } },
